              ...
              <div className="max-w-2xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    ...
                    className="px-6 py-3 bg-white hover:bg-gray-100 text-gray-900 rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg"
                  >
                    {status === "loading" ? (
                      "Loading..."
                    ) : (
                  ...
                  <button
                    ...
                    disabled={status === "loading"}
                    className="px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-bold transition-all border border-slate-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg"
                  >
                    {status === "loading" ? (
                      "Loading..."
                    ) : (
